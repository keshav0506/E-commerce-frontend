...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'Go to "Account > Order History", find your order, and click "Request Return" or contact our customer support team at support@shoply.com with your Order ID and product photos.'
  },
  {
    category: 'account',
