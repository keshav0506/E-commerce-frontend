...
import {
  ...
  uploadSupplierProductImageApi
} from '../../services/supplierService';
import { fetchCategories } from '../../services/apiService';
import type { Category } from '../../types';
import type { SupplierProductRequest } from '../../types/supplier';

export const SupplierEditProductPage: React.FC = () => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        setForm({
          ...
          image: prod.image,
          categoryId: prod.categoryId || (cats[0] ? Number(cats[0].id) : 1),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      await updateSupplierProductApi(id, form);
  ...
  if (loading) {
    return (
      <div className="p-16 flex flex-col items-center justify-center gap-3">
        ...
        <p className="text-xs font-bold text-gray-400">Loading product details...</p>
      </div>
    );
  }
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  value={form.sku || ''}
                  className="w-full p-3 bg-gray-100 border border-gray-200 rounded-2xl text-xs font-mono text-gray-500 cursor-not-allowed"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  step="0.01"
                  min="0"
                  value={form.discountPrice !== undefined ? form.discountPrice : ''}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-3 bg-gray-50 border border-gray-200 rounded-2xl text-xs sm:text-sm font-semibold text-gray-900 focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500"
                >
