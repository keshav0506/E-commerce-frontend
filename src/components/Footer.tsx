        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-10 border-b border-gray-100">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <div className="pt-2 flex items-center space-x-3 text-gray-400">
              <a href="#" aria-label="X Twitter" className="p-2 rounded-full bg-gray-50 hover:bg-rose-50 hover:text-rose-600 transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="p-2 rounded-full bg-gray-50 hover:bg-rose-50 hover:text-rose-600 transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <a href="#" aria-label="Facebook" className="p-2 rounded-full bg-gray-50 hover:bg-rose-50 hover:text-rose-600 transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="#" aria-label="LinkedIn" className="p-2 rounded-full bg-gray-50 hover:bg-rose-50 hover:text-rose-600 transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-600">
              <li>
                <button onClick={() => setSelectedCategoryId('all')} className="hover:text-rose-600 transition-colors cursor-pointer">
                  Products
                </button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => setSelectedCategoryId('snacks')} className="hover:text-rose-600 transition-colors cursor-pointer">
                  Deals
                </button>
              </li>
              <li>
                <button onClick={() => setSelectedCategoryId('beverages')} className="hover:text-rose-600 transition-colors cursor-pointer">
                  New Arrivals
                </button>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-600">
              ...
              <li><a href="#" className="hover:text-rose-600 transition-colors">Shipping Info</a></li>
              <li><a href="#" className="hover:text-rose-600 transition-colors">Returns & Refunds</a></li>
